...
docker build . -t berviantoleo/karsajobs:latest
...
docker tag berviantoleo/karsajobs:latest ghcr.io/berviantoleo/karsajobs:latest && docker push ghcr.io/berviantoleo/karsajobs:latest
